  ...
  ionViewDidLoad(){
    this.dbCards.loadcards().subscribe(cards => {
      ...
      this.dbCards.loadusercards().subscribe(ucards => {
        ...
        // y modificando su valor de la manera que sea este cambio se refleja en ese elemento mientras estemos
        // en el observable de manera que parece que en este caso, cuando accedemos a un elemento concreto con pilla3
        // y le modificamos el valor de counter en pilla 3, automaticamente se modifica el valor en cards.
        // Hay que estudiar bien como funciona esto de los observables, parece muy interesante
